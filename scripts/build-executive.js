...
<body>
    ...
    <section class="hero" id="home">
        <div class="hero-content">
            <div class="hero-text">
                ...
                <p class="hero-subtitle">VP of Technology at Deep Cognition</p>
                <p class="hero-description">
                    Leading the charge in AI innovation, I architect cutting-edge solutions that transform 
                    business processes through intelligent automation and advanced machine learning.
                </p>
            ...
            <div class="hero-image">
                <img src="https://santoshray.in/images/photo.png" alt="${data.name}" class="profile-photo" />
            </div>
        </div>
    </section>
    ...
    <section id="expertise" class="fade-in">
        ...
        <p class="section-subtitle">Driving innovation at the intersection of AI and business</p>
        
        <div class="expertise-grid">
            ${data.expertise.aiAgentsLLM.sections.llms.items.concat(data.expertise.aiAgentsLLM.sections.agents.items).map(item => `
    ...
    <section id="leadership" class="fade-in">
        ...
        <div class="leadership-philosophy">
            <p class="philosophy-text">
                "True innovation happens when we empower teams to think beyond conventional boundaries. 
                As a technology leader, my role is to create an environment where brilliant minds can 
                experiment, fail fast, learn faster, and ultimately deliver solutions that redefine 
                what's possible in AI and automation."
            </p>
        </div>
        ...
        <div class="achievements">
            <div class="achievement-card">
                ...
                <div class="achievement-label">AI Projects Delivered</div>
            </div>
            <div class="achievement-card">
                <div class="achievement-number">100M+</div>
                <div class="achievement-label">Documents Processed</div>
            </div>
            <div class="achievement-card">
                <div class="achievement-number">15+</div>
                <div class="achievement-label">Team Members Mentored</div>
            </div>
            <div class="achievement-card">
                <div class="achievement-number">10x</div>
                <div class="achievement-label">Efficiency Improvements</div>
            </div>
        </div>
    </section>
